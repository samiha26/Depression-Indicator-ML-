...
def count3(ans):
    ...
    while i < 4:
        ...
        i += 1
    if total < 10:
        print("You are in normal condition. You need to calm down a little bit. Perhaps you can chat with me?")
    elif total in range(10,14):
        print ("You are in mild condition. You are tired and need time for yourself. Perhaps you can chat with me?" )
    elif total in range(14,20):
        print("You are in moderate depression. You are tired and need a mental theraphy. Perhaps you can tell me your problem?")
    elif total in range(21,27):
        print("You are in severe depression. You have to take care of yourself first before others. Perhaps you can tell me your problem?")
    elif total > 27:
        print("You are in extreme severe depression. You have to take care of yourself first before others. Perhaps you can tell me your problem?")
...
def askMore():
    for resp in questions:
        print(f"{bot_name}:"+ resp +" Rate from 0 to 3")
        sentence = input("You: ")
        countt(sentence)
    count3(ans)
